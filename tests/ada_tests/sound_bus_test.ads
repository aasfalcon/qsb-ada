...
package Sound_Bus_Test is
   ...
   procedure Has_Runner_Test (This : in out Instance);
   procedure Get_Data_Underruns_Test (This : in out Instance);
   procedure Get_Signal_Underruns_Test (This : in out Instance);
   procedure Add_Runner_Test (This : in out Instance);
   ...
   procedure Remove_Runner_Test (This : in out Instance);
   procedure Send_Test (This : in out Instance);
   procedure Set_Watcher_Test (This : in out Instance);
   procedure Set_Analyzer_Test (This : in out Instance);
   procedure Watch_Test (This : in out Instance);

   procedure Stress_Emit_Test (This : in out Instance);
   procedure Stress_Show_Test (This : in out Instance);
   procedure Stress_Send_Test (This : in out Instance);
